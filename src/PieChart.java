...
public class PieChart {
    ...
    public PieChart(ParseTree tree) {
        this.tree = tree;
    ...
    public String toString() {
        if (ableToCreate) {
            return "slice kind: kind_of(" + sliceKind + ")\nslice value: count_of("
                                          + sliceValue + ") of the respective slice_kind\n";
        } else {
    ...
    public boolean createChart() {
        ...
        if (sliceValues.size() != 1 || sliceKinds.size() != 1) {
            ...
            sliceValue = sliceValues.toArray()[0].toString();
            sliceKind = sliceKinds.toArray()[0].toString();
            return true;
        }
